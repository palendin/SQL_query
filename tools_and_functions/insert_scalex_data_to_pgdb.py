...
def insert_scalex_csv_data_to_pgdb(df, table):
    ...
    try:
        ...
        query = f'''INSERT INTO dcu.{table}({columns}) VALUES ({placeholders})''' # ON CONFLICT (id) DO UPDATE SET {update_columns}'''
...
if __name__ == "__main__":
    ...
    insert_scalex_csv_data_to_pgdb()
